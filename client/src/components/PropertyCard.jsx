...
function PropertyCard({ propertyId, name, image, address, phone }) {
  ...
  const handleFavoriteClick = e => {
    ...
    const postOptions = { 
      ...
      body: JSON.stringify({ user_id: 1, property_id: propertyId })};
    ...
    <Card sx={{ minWidth: 275, maxWidth: 450 }}>
      ...
      <CardContent>
        <Stack direction='row' alignItems='center' justifyContent='space-between' spacing={2}>
          ...
          <Checkbox icon={<EmptyHeart size='small' />} checkedIcon={<FullHeart size='small' />} onChange={handleFavoriteClick} checked={checked} />
        </Stack>
